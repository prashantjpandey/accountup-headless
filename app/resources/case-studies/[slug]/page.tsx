...
import { caseStudyResources, getResourceByCategoryAndSlug } from "@/lib/resources";
...
export async function generateStaticParams() {
  return caseStudyResources.map((resource) => ({ slug: resource.slug }));
}
...
export async function generateMetadata({
  ...
  const resource = getResourceByCategoryAndSlug("case-study", slug);
    ...
    <section className="surface-default page-shell py-16 sm:py-20 md:py-24">
      <div className="page-container">
        <div className="mx-auto max-w-3xl rounded-[2rem] border border-black/8 bg-white/82 px-6 py-10 shadow-[0_20px_46px_-34px_rgba(15,23,42,0.34)] sm:px-8 md:px-10 md:py-12">
          <p className="eyebrow-chip">Case Study Placeholder</p>
          ...
          <p className="mt-6 text-sm leading-7 text-charcoal sm:text-base">
            This resource is being prepared. If you want the strategic version of
            this breakdown now, Accountup can walk you through it directly.
          </p>
